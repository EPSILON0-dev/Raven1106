...
BR2_OUTPUTS="rootfs.ext4 rootfs.tar rv1106g-evb1-v11.dtb rv1106_idblock_v1.15.102.img uboot.img zImage"
...
"$UBOOT_TOOLS/mkenvimage" -s 0x8000 -p 0x0 -o "$IMAGE_DIR/env.image" "$CONFIG_DIR/image_env.txt"
